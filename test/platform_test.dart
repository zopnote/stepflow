...
void main() => group("Platform representation interfaces", () {
  test("Ensure that the platform detection is validate.", () {
    ...
    print("Detected Version: ${current.attributes.version.major}.${current.attributes.version.minor}.${current.attributes.version.patch}");
  ...
  test("FirstWhereOrNullExtension works correctly", () {
    ...
    expect(stepflow.FirstWhereOrNullExtension(list).firstWhereOrNull((e) => e == 3), equals(3));
    expect(stepflow.FirstWhereOrNullExtension(list).firstWhereOrNull((e) => e == 6), isNull);
    expect(stepflow.FirstWhereOrNullExtension([]).firstWhereOrNull((e) => true), isNull);
  });
});
